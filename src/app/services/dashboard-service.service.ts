...
export class DashboardServiceService {
  ...
  postDonorSubscription(sub: PushSubscription){
    return this.http.post<any>("https://wecareserver.herokuapp.com/subscribe-donor", sub)
  }
  postRegisterSubscription(sub: PushSubscription){
    return this.http.post<any>("https://wecareserver.herokuapp.com/subscribe-register", sub)
  }
